...
routes.post("/uploads", upload.single("upload"), UploadController.store);
...
routes.put(
  "/users/security",
  Authorizations.show,
  SessionController.changeSecurity
);
...
routes.put(
  "/admin/users/tipo_user",
  Authorizations.show,
  TipoUsersController.update
);
...
routes.put(
  ...
  Authorizations.show,
  ConteudosController.update
);
routes.delete(
  "/conteudos/:id_conteudo",
  Authorizations.show,
  ConteudosController.delete
);

routes.get("/comentarios/:id_conteudo", ComentariosController.index);
routes.post(
  "/comentarios/:id_conteudo",
  Authorizations.show,
...
routes.put(
  "/comunidade/topico/:id_topico_comunidade",
  Authorizations.show,
  TopicoController.update
);

routes.get(
  "/comunidade/resposta/:id_topico_comunidade",
  RespostaController.index
);
routes.post(
  "/comunidade/resposta/:id_topico_comunidade",
  Authorizations.show,
  RespostaController.store
);
routes.put(
  "/comunidade/resposta/:id_topico_comunidade",
  Authorizations.show,
